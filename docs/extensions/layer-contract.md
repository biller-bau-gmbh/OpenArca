...
- Comma-separated layer roots, absolute or relative. Relative paths resolve against `ROOT_DIR`, matching the existing behaviour of `toAbsolutePath` in `config.js`.
